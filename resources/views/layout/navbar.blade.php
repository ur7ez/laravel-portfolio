        ...
        <div class="flex -mx-4 items-center justify-between relative">
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="w-full flex items-center py-2">
                    ...
                    />
                    <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">URCoding</span>
                </a>
            </div>
            <div class="flex px-4 justify-end items-center w-full">
                <div>
                    ...
                    <nav
                        ...
                        id="navbarCollapse"
                        class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none lg:px-0 dark:bg-slate-900 dark:text-gray-300"
                    >
